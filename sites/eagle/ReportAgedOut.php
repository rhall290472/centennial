...
<body>
  ...
  $csv_hdr = "Unit Type,Unit#, Gender, Name, Aged Out Date";
  $csv_output = "";
  ?>
  <center>
    <h4>Scouts who have Aged out of the Scouting Program</h4>
    <div class="px-5">
      <table class="fixed_header table table-striped">
        ...
        (`UnitType`='$SelectedUnit') AND (`UnitNumber`='$SelectedNum') ORDER BY `UnitType` ASC, `UnitNumber` ASC,`Gender` ASC,`LastName` ASC";
        } else {
