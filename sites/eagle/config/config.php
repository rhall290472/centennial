...
$host = $is_localhost ? ($_SERVER['SERVER_NAME'] ?? 'localhost') : 'eagle.centennialdistrict.co';
...
define('PAGE_DESCRIPTION', 'Review Eagles for the Centennial District');
