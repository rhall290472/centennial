  ...
  <div class="container-fluid">
    ...
    <script>
      $(document).ready(function() {
        console.log('Starting DataTable initialization for previewTable');
        ...
        $('#previewTable').DataTable({
          ...
          buttons: [{
              ...
              title: 'Centennial District Scouts Not Attended Preview Report'
            },
            {
              extend: 'csv',
              className: 'btn btn-primary btn-sm d-print-none mt-2',
              filename: 'Centennial District Scouts Not Attended Preview Report'
            },
            {
              extend: 'excel',
              className: 'btn btn-primary btn-sm d-print-none mt-2',
