...
$host = $is_localhost ? ($_SERVER['SERVER_NAME'] ?? 'localhost') : 'da.centennialdistrict.co';
...
$pageHome = SITE_URL.'/centennial/sites/districtawards/public/index.php';
$pageContact = SITE_URL . '/centennial/sites/districtawards/src/Pages/contact.php';
// Navigation links
define('NAV_LINKS', [
    [
        'href' => $pageHome,
