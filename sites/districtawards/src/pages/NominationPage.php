...
if (isset($_POST['SubmitForm'])) {
  if (filter_input(INPUT_POST, 'SubmitForm') == "Cancel") {
    header("Location: index.php");
    exit;
  }
  $FormData = array();
  $FormData['NomineeIDX'] = -1; // New recorded
  $FormData['FirstName'] = htmlspecialchars($cDistrictAwards->GetFormData('element_1_1'));
  $FormData['PName'] =     htmlspecialchars($cDistrictAwards->GetFormData('element_1_2'));
  $FormData['MName'] =     htmlspecialchars($cDistrictAwards->GetFormData('element_1_3'));
  $FormData['LastName'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_1_4'));
  // If this is for Outstanding Leaders then gather all four names.
  if (filter_input(INPUT_GET, 'AwardIDX') == $cDistrictAwards::$OutStandingLeaders) {
    if (!empty(filter_input(INPUT_GET, 'element_2_1'))) {
      $FormData['FirstName2'] = htmlspecialchars($cDistrictAwards->GetFormData('element_2_1'));
      $FormData['PName2'] =     htmlspecialchars($cDistrictAwards->GetFormData('element_2_2'));
      $FormData['MName2'] =     htmlspecialchars($cDistrictAwards->GetFormData('element_2_3'));
      $FormData['LastName2'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_2_4'));
    }

    if (!empty(filter_input(INPUT_GET, 'element_3_1'))) {
      $FormData['FirstName3'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_3_1'));
      $FormData['PName3'] =      htmlspecialchars($cDistrictAwards->GetFormData('element_3_2'));
      $FormData['MName3'] =      htmlspecialchars($cDistrictAwards->GetFormData('element_3_3'));
      $FormData['LastName3'] =   htmlspecialchars($cDistrictAwards->GetFormData('element_3_4'));
    }

    if (!empty(filter_input(INPUT_GET, 'element_4_1'))) {
      $FormData['FirstName4'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_4_1'));
      $FormData['PName4'] =      htmlspecialchars($cDistrictAwards->GetFormData('element_4_2'));
      $FormData['MName4'] =      htmlspecialchars($cDistrictAwards->GetFormData('element_4_3'));
      $FormData['LastName4'] =   htmlspecialchars($cDistrictAwards->GetFormData('element_4_4'));
    }
  }

  if (!empty(filter_input(INPUT_GET, 'element_6_1')))
    $FormData['Position'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_6_1'));
  else
    $FormData['Position'] = "";
  $FormData['Unit'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_6_2'));
  if (!empty(filter_input(INPUT_GET, 'element_6_3')))
    $FormData['MemberID'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_6_3'));

  // Get Disitrict of Merit data ...
  if (filter_input(INPUT_GET, 'AwardIDX') == $cDistrictAwards::$DistrictAwardofMerit) {
    $FormData['DLAward'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_7_1'));
    $FormData['SRAward'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_7_2'));
    $FormData['STAward'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_7_3'));

    $FormData['CoachAward'] =   htmlspecialchars($cDistrictAwards->GetFormData('element_8_1'));
    $FormData['SilverBeaver'] = htmlspecialchars($cDistrictAwards->GetFormData('element_8_2'));
    $FormData['ScouterKey'] =   htmlspecialchars($cDistrictAwards->GetFormData('element_8_3'));

    $FormData['CSAward'] =   htmlspecialchars($cDistrictAwards->GetFormData('element_9_1'));
    $FormData['WoodBadge'] = htmlspecialchars($cDistrictAwards->GetFormData('element_9_2'));
    $FormData['DCSA'] =      htmlspecialchars($cDistrictAwards->GetFormData('element_9_3'));

    $FormData['WDLAward'] = htmlspecialchars($cDistrictAwards->GetFormData('element_10_1'));
    $FormData['Other1'] =   htmlspecialchars($cDistrictAwards->GetFormData('element_10_2'));
    $FormData['Other2'] =   htmlspecialchars($cDistrictAwards->GetFormData('element_10_3'));
  }

  $FormData['Notes'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_14_1'));

  $FormData['NominatedBy'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_15_1'));
  $FormData['NominatedByUnit'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_15_2'));
  $FormData['NominatedByPosition'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_15_3'));

  $FormData['Year'] =  htmlspecialchars($cDistrictAwards->GetYear());
  $FormData['Award'] =  htmlspecialchars($cDistrictAwards->GetFormData('element_16_1'));
