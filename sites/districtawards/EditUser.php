...
<head>
  ...
  <meta name="description" content="EditUser.php">
</head>
...
<body class="body">
  ...
  if (isset($_GET['Userid'])) {
    ...
    $ResultUser = $cDistrictAwards->doQuery($sql);
    if (!$ResultUser) {
  ...
  if (isset($_POST['SubmitForm'])) {
    ...
    $FormData['Role'] = $cGOAT->GetFormData('element_2_2');
    ...
    $cDistrictAwards->doQuery($sql);

    $cDistrictAwards->GotoURL('./ViewUsers.php');
    exit;
  }
  ...
  <div style="padding:20px">
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" s id="form-user" method="post">
      ...
      <div class="form-row">
        ...
        <div class="col-1 py-4">
          <div class="form-check">
            <input class="form-check-input d-print-none" type="hidden" name="element_1_3" value='0' />
            <input class="form-check-input d-print-none" type="checkbox" name="element_1_3" value='1' <?php if ($user['is_deleted'] == 1) echo "checked=checked"; ?>>
            <label class="form-check-label d-print-none" for="element_1_3">Deleted</label>
          </div>
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="col-3">
          <label>Created</label>
          <input type="text" name="element_3_1" class="form-control" <?php if (strlen($user['created']) > 0) echo "value=" . $user['created']; ?> readonly />
        </div>
        <div class="col-2">
