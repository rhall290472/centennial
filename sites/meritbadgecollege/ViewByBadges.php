  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
      ...
      <div class="col-md-6 offset-md-1">
        ...
        $queryByMBCollege = sprintf("SELECT * FROM college_counselors WHERE College='%s' ORDER BY MBName", $CMBCollege->GetYear());
        $report_results = $CMBCollege->doQuery($queryByMBCollege, $CMBCollege->GetYear());
        if ($CMBCollege->ReportMeritBadges($report_results)) {
