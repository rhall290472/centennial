<br><b><?php echo $CMBCollege->GetDate($CMBCollege->GetYear()); ?></b></br>


			Registration link <a href="https://denverboyscouts.doubleknot.com/event/space-available/black-feather-merit-badge-college/76385">Click Here</a>
			Black Feather and Centennial District will be holding a Merit Badge College on <?php echo $CMBCollege->GetDate($CMBCollege->GetYear()); ?> at 
			...
			The District&apos;s would like to welcome all Merit Badge Counselor to please consider helping with this learning
			...
			<b>Counselors:</b>
			<br></br>
			Please view the College schedule to see what Merit Badges and period(s) have already been selected, you may offer a duplciate merit bagde but just at
			a different time.

			To signup to support this district event please select the Counselor signup link to the left and complete
			the signup form.

			Once you select your name from the Counselor drop down only the Merit Bagdes that you are apporved for will be shown
			
			<br></br>
			<a href="https://filestore.scouting.org/filestore/pdf/512-065.pdf">A Guide for Merit Badge Counseling</a></br>
			<b>Some thoughts from the <a href="https://filestore.scouting.org/filestore/pdf/33088.pdf?_gl=1*1qopu25*_ga*MjAxOTIzMzAzNS4xNjIxOTg3NTcy*_ga_20G0JHESG4*MTYyMTk4NzU3Mi4xLjEuMTYyMTk4NzcwNC4yMw..">Guide to Advancmenet</a></b><br></br>
