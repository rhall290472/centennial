...
//TODO: Need to move to different folder
$path_logon = SITE_URL . '/centennial/sites/advancement/src/Pages/logon.php';
$path_logoff = SITE_URL . '/centennial/sites/advancement/src/Pages/logoff.php';
