    ...
    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="<?php echo SITE_URL . '/centennial/sites/advancement/src/Pages/Untrained.php?MemberID=&btn=ByLastName'; ?>" class=" dropdown-item">Untrained Leaders</a></li>
          <li><a href="<?php echo SITE_URL . '/centennial/sites/advancement/src/Pages/YPT.php?MemberID=&btn=ByLastName'; ?>" class=" dropdown-item">Expired YPT</a></li>
        </ul>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="<?php echo SITE_URL . '/centennial/sites/advancement/src/Pages/pack_summary.php'; ?>" class="dropdown-item">Summary</a></li>
