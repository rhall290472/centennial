    ...
    <div class="row flex-nowrap">
      ...
      <div class="col py-3">
          ...
          <div class="container px-lg-5">
            <div class="p-4 p-lg-5 bg-light rounded-3 text-center">
              <div class="m-4 m-lg-5">
                <h1 class="display-5 fw-bold">Users for the Advancement Database</h1>
        ...
        <section class="py-5">
          ...
          $sql = "SELECT * FROM users WHERE is_deleted IS NULL OR is_deleted <> 1";
          $result = $cAdvancement->doQuery($sql);
          if ($result) {
            // Display the events 
          ?>
