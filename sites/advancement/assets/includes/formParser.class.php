				...
				switch($v['dataType'])
				{
					case "input":
						foreach($v['fields'] as $if_label => $if_pattern)
						{
							...
							$form .= '<input'.$v['id'].'type="text" class="form-control '.$v['class'].'" name="'.$name.'" placeholder="'.$placeholder.'" value="'.$values.'"  />' . $this->newLine;
					...
					case "input-upload":
						foreach($v['fields'] as $if_label => $if_pattern)
						{
							...
							$form .= $this->beforeRow . $this->newLine;
							$form .= '<label>'.$if_label.'</label>' . $this->newLine;
							$form .= '<input'.$v['id'].'type="file" class="form-control '.$v['class'].'" name="'.$name.'" placeholder="'.$placeholder.'" value="'.$values.'"  />' . $this->newLine;
							$form .= $this->afterRow . $this->newLine;
						}
					break;
					...
					case "textarea":
						foreach($v['fields'] as $if_label => $if_pattern)
						{
							...
							$form .= $this->beforeRow . $this->newLine;
							$form .= '<label>'.$if_label.'</label>' . $this->newLine;
							$form .= '<textarea'.$v['id'].'class="form-control '.$v['class'].'" name="'.$name.'" placeholder="'.$placeholder.'">'.$values.'</textarea>' . $this->newLine;
							$form .= $this->afterRow . $this->newLine;
						}
					break;
					...
					case "select":
						...
						foreach($v['fields'] as $if_label => $if_pattern)
						{
							...
							$form .= $this->beforeRow . $this->newLine;
							$form .= '<label>'.$if_label.'</label>' . $this->newLine;
							$form .= '<select'.$v['id'].'class="form-control '.$v['class'].'" name="'.$name.'">' . $this->newLine;
